...
},
{
  ...
  text: '订单管理'
  //           cList: [
  //   { cid: 100, to: "/indexPage/rule", text: "权限设置" },
  //   { cid: 101, to: "/indexPage/auth", text: "角色设置" },
  //   { cid: 102, to: "/indexPage/systemCycle", text: "时长设置" },
  //   { cid: 103, to: "/indexPage/departSetNum", text: "部门配额" },
  //   { cid: 104, to: "/indexPage/accountManage", text: "账号管理" },
  //   { cid: 105, to: "/indexPage/news", text: "公告管理" },
  // ],
},
{
  id: 9,
