<template>
  <div class="activity component-container media-padding">
    ...
    <el-table stripe :data="acList" style="width: 100%">
      ...
      <el-table-column prop="" label="操作" width="80">
        <template slot-scope="scope">
          <el-button type="primary" size="mini" @click.native="editName('activity',scope.row.id,scope.row.code_desc)">修改
          </el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-table stripe :data="proList" style="width: 100%">
      ...
      <el-table-column prop="" label="操作" width="80">
        <template slot-scope="scope">
          <el-button type="primary" size="mini" @click.native="editName('pro',scope.row.id,scope.row.code_desc)">修改
          </el-button>
        </template>
      </el-table-column>
    </el-table>
