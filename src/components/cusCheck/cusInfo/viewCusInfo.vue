<template>
  <div class="view-cus-info child-component-container media-padding">
    <div class="detail-main">
          ...
          <el-row :gutter="20">
            <el-col :md="24" style="max-width:1000px;">
              <el-form-item label="客户类型 :" required>
                <el-select v-model="form.cusType" :disabled="disabled" placeholder="客户来源" style="width:100%;">
                  <el-option value="10" label="个人查找"></el-option>
                  <el-option value="20" label="个人查找"></el-option>
                </el-select>
              </el-form-item>
          ...
          <el-row :gutter="20">
            <el-col :md="24" style="max-width:1000px;">
              <el-form-item label="备注 :" required>
                <el-input v-model="form.remark" :disabled="disabled" type="textarea" :rows="4" placeholder="经营范围"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :md="24" style="max-width:1000px;">
              <el-form-item label="审核备注 :" required>
                <el-input v-model="form.checkRemark" :disabled="disabled" type="textarea" :rows="4" placeholder="经营范围"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <div class="btns mt10px" style="max-width:1000px;text-align:center;">
            <el-button type="success" @click.native="aaa">保存客户资料</el-button>
            <el-button type="danger" @click.native="aaa">驳 回</el-button>
          </div>
        </el-form>
      </div>
      <div class="follow-record mt10px">
        ...
        <el-tabs v-model="activeName" style="width:100%;" type="card" @tab-click="handleClick">
          ...
          <el-tab-pane label="修改记录" name="2">角色管理</el-tab-pane>
          <el-tab-pane label="申请修改记录" name="3">角色管理</el-tab-pane>
        </el-tabs>
      </div>
    </div>
  </div>
