        ...
        <el-row>
          ...
          <el-table
            ...
            <el-table-column
              ...
              prop="''">
              <span slot-scope="scope">
                {{scope.row.wfndStatus==300?scope.row.orderAmount:
                (scope.row.reckStatus==300?scope.row.renewMoney:null) | currency}}
              </span>
            </el-table-column>
            <el-table-column
              v-if="selStatus!==-10"
              ...
              prop="''">
              <span slot-scope="scope">
                {{scope.row.wfndStatus==300?scope.row.orderTime:
                (scope.row.reckStatus==300?scope.row.renewTime:null) | timeFormat1}}
              </span>
            </el-table-column>
            <el-table-column label="操作" prop="" v-if="selStatus=== -10||selStatus===10">
              <template slot-scope="scope">
                <el-button
                  @click.native.prevent="chai(myCusList[scope.$index])" type="warning" size="mini">
                  拆账
                </el-button>
              </template>
            </el-table-column>
            <el-table-column label="查看" prop="">
              <template slot-scope="scope">
                <el-button
                  @click.native.prevent="view(myCusList[scope.$index])" type="success" size="mini">
                  查看
                </el-button>
              </template>
            </el-table-column>
