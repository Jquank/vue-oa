        ...
        >
          <span slot-scope="scope">
            <el-button
              ...
              plain
              class="xsbtn"
            >{{scope.row.currentname?scope.row.currentname:'订单完成'}}</el-button>
          </span>
        </el-table-column>
        <el-table-column
          prop=""
    ...
    >
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <el-button
              @click.native="handleSelCompany(scope.row)"
              type="primary"
              class="xsbtn"
            >选择</el-button>
          </template>
...
export default {
  ...
  components: {
    Page, AutoSelect, MakeInvoiceDialog, SelectUser
  }
}
</script>
