        ...
        <el-row>
          <el-col :md="24" class="maxwidth">
            <el-form-item label="验证方式:" required>
              ...
              <el-radio v-model="form.checkType" label="20">人脸识别</el-radio>
            </el-form-item>
          </el-col>
        </el-row>
          ...
          <el-col :md="24" class="maxwidth">
            <el-form-item label="合同编号:">
              <el-row :gutter="5" type="flex" style="flex-wrap:wrap;">
                ...
                <el-col :md="8">
                  <el-select v-model="form.bdProxy" @change="selProxy(form.bdProxy)" placeholder="百度本地直通车服务合同">
...
export default {
  ...
  methods: {
    ...
    subOrder (subType) {
      ...
      this.$post('/wf.do?goZTC', params).then(res => {
        if (res.data.success && !this.showEditZTC) {
          this.$router.push({
