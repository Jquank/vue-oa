  ...
  <div class="my-customer">
    ...
    <div class="my-main">
      ...
      <el-row>
        <!-- 搜索条件之 地区 -->
        <el-col :span="8">
          <area-cascader style="margin-top:10px;" placeholder="请选择地区"
            type='text' v-model="area" :level='1' :data="pcaa"></area-cascader>
        </el-col>
        <!-- 搜索条件之 行业 -->
        <el-col :span="8">
          <area-cascader style="margin-top:10px;" placeholder="请选择行业"
            type='text' v-model="trade" :level='0' :data="pca"></area-cascader>
        </el-col>
        <el-col :span="8">
        ...
        <el-col :span="24" class="my-list-col">
          <el-table
            ...
            <el-table-column
              ...
              label="公司状态" width="70">
              <span
                :class="scope.row.companytype===-10?'redfont':''"
                slot-scope="scope">
            ...
            <el-table-column
              ...
              <span
                slot-scope="scope">
                {{scope.row.producttype | cusStatus}}
                {{scope.row.producttype===0?scope.row.productnumber+1:''}}
              </span>
            </el-table-column>
            <el-table-column
              prop="areaname"
            ...
            <el-table-column
              prop=""
              label="业务状态" width="120">
              <span
                :class="scope.row.companylogstatus===10?'redfont':''"
                slot-scope="scope">
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <el-button
                  @click.native.prevent="viewDetail(myCusList[scope.$index])" type="success" size="mini">
                  查看
                </el-button>
              </template>
            </el-table-column>
